...
def solve_pattern(
    ...
    *,
    ...
    1. Initialize:
        ...
        sequence, if the sequence is in the list of basic moves. I.e. if the sequence is "U",
        then the action space will include "U", "U2", and "U'".
    ...
    Args:
        ...
        generator (MoveGenerator): Generator for actions at each step.
